...
DEFUN_DLD(var_immediate_update, args, , "-*- texinfo -*-\n\
...
@end deftypefn")
{
    ...
    octave_value_list v(2);
    v(0) = var_name_string;
    v(1) = "var";
    bool var_exists = octave::feval("exist", v)(0).bool_array_value()(0);
    if (!var_exists) return octave_value(out);
	...
	*/
    ...
    str_output = str_message_immediate_update + "  " + var_name_string + "," + filename + "\n";
    myfile << str_output;
    myfile.close();
